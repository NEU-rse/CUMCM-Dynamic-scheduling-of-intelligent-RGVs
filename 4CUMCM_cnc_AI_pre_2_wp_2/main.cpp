//附录四、假设无故障且加入“智能预测”与“就近原则”算法的两道工序C语言程序：
...
int main()
{
    int odd[4]={1,3,5,7}, even[4]={2,4,6,8}, l, m, pl, tmr=0, t_sxl[2], t_qx, t_work[2], t_mov[3], zjbl, t_CNC_1[4]={0}, t_CNC_2[4]={-1000,-1000,-1000,-1000}, i, Rank1[4]={0}, Rank2[4]={1,2,3,4}, j=0, k=3, p, q, place=1, A, N=1, TN_CNC1[4][200]={0}, N_CNC1[4]={1,1,1,1}, TN_CNC2[4][200]={0}, N_CNC2[4]={1,1,1,1};     ///定义执行各道工序的时间变量
        ...
        else    ///服务队列1中有CNC待服务。
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    printf("%d material CNC1: CNC%d# First step Time down: %5d up: %5d CNC2: CNC%d3 Second Time down: %5d up: %5d\n",N, odd[zjbl-1], TN_CNC1[zjbl-1][N_CNC1[zjbl-1]-1], TN_CNC1[zjbl-1][N_CNC1[zjbl-1]-2], even[Rank2[pl-1]-1], TN_CNC2[Rank2[pl-1]-1][N_CNC2[Rank2[pl-1]-1]-1], TN_CNC2[Rank2[pl-1]-1][N_CNC2[Rank2[pl-1]-1]-2]);
                    tmr += A;
                    Tplus(A,t_CNC_2,Rank2[pl-1]);
                    Tplus1(A,t_CNC_1);
