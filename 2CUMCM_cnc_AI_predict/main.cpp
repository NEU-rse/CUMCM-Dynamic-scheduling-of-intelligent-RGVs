//附录二、假设无故障且加入“智能预测”算法的一道工序C语言程序
...
int main()
{
    int t_sxl[2], t_qx, t_work, t_mov[3], i, tmr=0, t_CNC[8]={0}, Rank[8]={0}, j=0, place=1, N=1, A, k, B, TN_CNC[8][200]={0}, N_CNC[8]={1,1,1,1,1,1,1,1}, st;     ///定义执行各种子工序的时间变量
